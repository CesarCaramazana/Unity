...
public class Bullet : MonoBehaviour
{
    ...
    [SerializeField] private float bulletAcceleration = 1f;
    [SerializeField] public float bulletTimeToLive = 3f;
    ...
    {
        bulletSpeed += bulletAcceleration * Time.deltaTime;
    ...
    public void SetBulletAcceleration(float acceleration) 
    {
    ...
    private void OnHitObject(RaycastHit hit)
    {
        ...
        if(hitFX != null) Destroy(Instantiate(hitFX.gameObject, hit.point, Quaternion.FromToRotation(-Vector3.forward, hit.point)) as GameObject, 0.4f);
