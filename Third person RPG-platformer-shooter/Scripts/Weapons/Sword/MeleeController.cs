...
public class MeleeController : MonoBehaviour
{
    ...
    public void EquipSword(Sword swordToEquip)
    {
        ...
        equippedSword = Instantiate(swordToEquip, swordHoldPoint) as Sword;
        //equippedSword = Instantiate(swordToEquip, swordHoldPoint.position, Quaternion.identity) as Sword;

        //equippedSword = Instantiate(swordToEquip) as Sword;
        //equippedSword.transform.parent = swordHoldPoint;
        //equippedSword.transform.position = swordHoldPoint.position;
        //equippedSword.transform.rotation = swordHoldPoint.rotation;
    }
