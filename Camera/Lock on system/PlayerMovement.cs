...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField] private float timeBetweenFootsteps = 0.28f;
    ...
    private void Move()
    {
        ...
        else
        {
            ...
            if(!isLockedOn) FaceCameraForward();
    ...
    private void ResetLookAtTarget()
    {
        ...
        Quaternion rotation = new Quaternion(0f, transform.rotation.y, 0f, transform.rotation.w);
